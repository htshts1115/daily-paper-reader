...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-08 23:07:57 UTC<br>状态：成功</p>
</section>
...
<p>今日精读 1 篇论文，聚焦医学影像分割中的指南一致性问题。</p>
<p>最值得关注的是《InsightSeg》，核心思路是复用人工修正经验来提升分割结果与临床指南的符合度，获得 8.0/10 分。</p>
<p>建议若你关注落地场景中的修正反馈机制，可深挖该方法的通用性与数据需求。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="InsightSeg: Reusing Correction Insights for Guideline-Consistent Segmentation">InsightSeg: Reusing Correction Insights for Guideline-Consistent Segmentation</span></li></ul>
  </div>
